 ...
 * @generated
 */
public class PickupnetSwitch<T> extends Switch<T> {
	/**
   ...
   */
    ...
    switch (classifierID)
    {
      ...
      case PickupnetPackage.CUSTOMER:
      {
      ...
      case PickupnetPackage.SHIPMENT:
      {
