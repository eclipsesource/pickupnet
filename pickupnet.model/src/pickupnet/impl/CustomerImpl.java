...
public class CustomerImpl extends EObjectImpl implements Customer {
   ...
   * @ordered
   */
	protected EList<Shipment> orders;
   ...
   */
    ...
    return PickupnetPackage.Literals.CUSTOMER;
  }
   ...
   */
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PickupnetPackage.CUSTOMER__NAME, oldName, name));
  }
