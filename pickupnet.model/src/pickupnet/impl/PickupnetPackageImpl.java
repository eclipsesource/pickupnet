...
public class PickupnetPackageImpl extends EPackageImpl implements PickupnetPackage {
   ...
   * @generated
   */
	private EDataType geoLocationEDataType = null;
   ...
   * @generated
   */
	public EAttribute getAddress_GeoLocation() {
   ...
   * @generated
   */
	public EDataType getGeoLocation() {
    return geoLocationEDataType;
  }
   ...
   */
    ...
    createEAttribute(addressEClass, ADDRESS__GEO_LOCATION);

    // Create enums
    shipmentStatusEEnum = createEEnum(SHIPMENT_STATUS);

    // Create data types
    geoLocationEDataType = createEDataType(GEO_LOCATION);
  }
   ...
   */
    ...
    op = addEOperation(stationEClass, null, "acceptShipment", 1, 1, IS_UNIQUE, IS_ORDERED);
    ...
    initEAttribute(getAddress_GeoLocation(), this.getGeoLocation(), "geoLocation", null, 0, 1, Address.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEDataType(geoLocationEDataType, GeoLocation.class, "GeoLocation", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
