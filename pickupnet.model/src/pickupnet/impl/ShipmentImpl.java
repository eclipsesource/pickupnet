...
public class ShipmentImpl extends EObjectImpl implements Shipment {
  ...
  /**
   * The cached value of the '{@link #getDriver() <em>Driver</em>}' reference. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getDriver()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getShipToAddress() <em>Ship To Address</em>}' containment
  ...
  /**
   * The cached value of the '{@link #getPickUpAddress() <em>Pick Up Address</em>}' containment
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
      ...
      if( driver != oldDriver ) {
        if( eNotificationRequired() )
          eNotify( new ENotificationImpl( this,
                                          ...
                                          PickupnetPackage.SHIPMENT__DRIVER,
                                          oldDriver,
                                          driver ) );
      }
    }
    ...
    if( newDriver != driver ) {
      ...
      if( driver != null )
        msgs = ( ( InternalEObject )driver ).eInverseRemove( this,
                                                             PickupnetPackage.DRIVER__ASSIGNMENTS,
                                                             Driver.class,
                                                             msgs );
      if( newDriver != null )
  ...
  public Customer getOrderer() {
    if( eContainerFeatureID() != PickupnetPackage.SHIPMENT__ORDERER )
      return null;
  ...
  public NotificationChain basicSetOrderer( Customer newOrderer, NotificationChain msgs ) {
    msgs = eBasicSetContainer( ( InternalEObject )newOrderer,
                               PickupnetPackage.SHIPMENT__ORDERER,
                               msgs );
    return msgs;
  }
  ...
  public void setOrderer( Customer newOrderer ) {
    if( newOrderer != eInternalContainer()
        || ( eContainerFeatureID() != PickupnetPackage.SHIPMENT__ORDERER && newOrderer != null ) )
    {
      ...
      if( newOrderer != null )
        msgs = ( ( InternalEObject )newOrderer ).eInverseAdd( this,
                                                              PickupnetPackage.CUSTOMER__ORDERS,
                                                              Customer.class,
                                                              msgs );
  ...
  public NotificationChain basicSetShipToAddress( Address newShipToAddress, NotificationChain msgs )
  {
    ...
    if( eNotificationRequired() ) {
      ENotificationImpl notification = new ENotificationImpl( this,
                                                              Notification.SET,
                                                              PickupnetPackage.SHIPMENT__SHIP_TO_ADDRESS,
                                                              oldShipToAddress,
                                                              newShipToAddress );
      if( msgs == null )
        msgs = notification;
  ...
  public void setShipToAddress( Address newShipToAddress ) {
    if( newShipToAddress != shipToAddress ) {
      NotificationChain msgs = null;
      if( shipToAddress != null )
        msgs = ( ( InternalEObject )shipToAddress ).eInverseRemove( this,
                                                                    EOPPOSITE_FEATURE_BASE
                                                                        - PickupnetPackage.SHIPMENT__SHIP_TO_ADDRESS,
                                                                    null,
                                                                    msgs );
      if( newShipToAddress != null )
        msgs = ( ( InternalEObject )newShipToAddress ).eInverseAdd( this,
                                                                    EOPPOSITE_FEATURE_BASE
                                                                        - PickupnetPackage.SHIPMENT__SHIP_TO_ADDRESS,
                                                                    null,
                                                                    msgs );
  ...
  public NotificationChain basicSetPickUpAddress( Address newPickUpAddress, NotificationChain msgs )
  {
    ...
    if( eNotificationRequired() ) {
      ENotificationImpl notification = new ENotificationImpl( this,
                                                              Notification.SET,
                                                              PickupnetPackage.SHIPMENT__PICK_UP_ADDRESS,
                                                              oldPickUpAddress,
                                                              newPickUpAddress );
      if( msgs == null )
        msgs = notification;
  ...
  public void setPickUpAddress( Address newPickUpAddress ) {
    if( newPickUpAddress != pickUpAddress ) {
      NotificationChain msgs = null;
      if( pickUpAddress != null )
        msgs = ( ( InternalEObject )pickUpAddress ).eInverseRemove( this,
                                                                    EOPPOSITE_FEATURE_BASE
                                                                        - PickupnetPackage.SHIPMENT__PICK_UP_ADDRESS,
                                                                    null,
                                                                    msgs );
      if( newPickUpAddress != null )
        msgs = ( ( InternalEObject )newPickUpAddress ).eInverseAdd( this,
                                                                    EOPPOSITE_FEATURE_BASE
                                                                        - PickupnetPackage.SHIPMENT__PICK_UP_ADDRESS,
                                                                    null,
                                                                    msgs );
