...
public class PickupnetFactoryImpl extends EFactoryImpl implements PickupnetFactory {
   ...
   */
    ...
    switch (eDataType.getClassifierID())
    {
      ...
      case PickupnetPackage.GEO_LOCATION:
        return createGeoLocationFromString(eDataType, initialValue);
      default:
   ...
   */
    ...
    switch (eDataType.getClassifierID())
    {
      ...
      case PickupnetPackage.GEO_LOCATION:
        return convertGeoLocationToString(eDataType, instanceValue);
      default:
        throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
    }
  }
   ...
   * @generated
   */
	public GeoLocation createGeoLocationFromString(EDataType eDataType, String initialValue) {
    return (GeoLocation)super.createFromString(eDataType, initialValue);
  }
   ...
   * @generated
   */
	public String convertGeoLocationToString(EDataType eDataType, Object instanceValue) {
